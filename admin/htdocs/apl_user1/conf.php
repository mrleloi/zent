...
$thisPage->setAddHeader('<link href="' . $thisPage->shared_path . '/css/bootstrap-table.min.css" rel="stylesheet">');
$thisPage->setAddHeader('<script src="' . $thisPage->shared_path . '/js/bootstrap-table.min.js"></script>');
